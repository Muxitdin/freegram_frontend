export default function Starter({ txt, extraStyle, positioning }) {
    return (
        ...
        // </div>
        <div className={`${extraStyle} h-screen relative flex flex-1 items-center justify-center bg-secondary`}>
            <h1 className={`${positioning} z-10 text-text text-base bg-gray-400 rounded-2xl px-2 py-1 backdrop-blur-xl`}>
                {txt}
            </h1>
        </div>
    )
