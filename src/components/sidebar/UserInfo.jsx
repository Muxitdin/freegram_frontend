    ...
    return (
        <div className="w-1/4 flex flex-col gap-4 relative shadow-xl z-20 px-4 py-3 bg-primary">
            <header className="flex items-center gap-8">
                <button onClick={() => setUserModal(prev => !prev)} className="text-2xl text-text transition-all hover:text-gray-500"><HiOutlineXMark /></button>
                <h1 className="text-xl text-text">User Info</h1>
            </header>
